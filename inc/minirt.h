...
/*   Updated: 2023/07/06 15:06:06 by rriyas           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_hit_record	construct_hit_rec(t_hit_record *hrec, float dist, t_vec3 normal,
					t_surface *surf);
t_hit_record	ray_cylinder_intersect(t_ray ray, t_surface *cyl, float t0,
					float t1);
t_hit_record	ray_plane_intersect(t_ray ray, t_surface *plane, float t0,
					float t1);
t_hit_record	ray_sphere_intersect(t_ray ray, t_surface *sphere, float t0,
					float t1);
